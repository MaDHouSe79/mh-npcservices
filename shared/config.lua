...
Config.InteractDiustance      = 1.0              -- Default 1.0, the distance when the npc can interact with the vehicle or player
Config.MinOnlineEMS           = 1                -- Default 1, How many ems people have to be online, to iqnore the npc services.
Config.Cooldown               = 350000           -- Default 25000, A cooldown, (5mins) this is so players can't spam it.
Config.AutoCallAmbulance      = true             -- Default true, if true, it calls the ambulance automatically for you.
Config.AutoCallTimer          = 25000            -- Default 20000, A timer to call ambulance automatically after 20secs.
Config.ForceFirstperson       = false            -- Default false, it force firstperon when inside a job vehicle.
Config.MinDamageForFlatbed    = 750              -- Default 750, a flatbed is comming if the vehicle damage is below this value.
Config.RadialMenuIcone        = "star-of-life"   -- Default "star-of-life", icon form the radial menu.
Config.PhoneModel             = "prop_amb_phone" -- Default prop_amb_phone, hand phone, if you have a other phone model, you can use it here
Config.MechanicProp           = "imp_prop_impexp_span_03"
Config.StuckTimerCheck        = 15               -- Default 15, a stuck timer check.
Config.StuckResetTimer        = 15               -- Default 15, reset stuck time.
Config.UseUnlimitHealth       = true             -- if true, all service peds and vehicles will have unlimit health (god mode).
...
Config.NPCVehicles = {   -- Job Vehicles
    ['police']        = {models = {"riot"}},
