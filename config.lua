...
Config.Service = {                           
    ...
    ['police'] = {
        ...
        minJailTime = 20, -- 2 min min jail time (Default: 120)
        maxJailTime = 50, -- 5 min max jail time (Default: 350)
    ...
    ['taxi'] = {
        name        = "Taxi",
        job         = "taxi",
        ped         = "a_m_y_stlat_01", -- or a_m_y_stlat_01 or a_m_y_smartcaspat_01
        plate       = "NPC-TAXI",
        color       = 46,
        speed       = 29.0,
        price       = 10,
